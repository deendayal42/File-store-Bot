...
STREAM_LOGS = environ.get('STREAM_LOGS','-1001970548842')
...
class Config(object):
	...
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002050862981")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1001970548842")
